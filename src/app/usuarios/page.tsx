      ...
      <main className="p-6 max-w-3xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="space-y-3">
            {usuarios.map((u) => (
              <div key={u.id} className={`bg-white rounded-xl shadow px-5 py-4 flex justify-between items-center ${!u.activo ? 'opacity-50' : ''}`}>
                <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  {u.rol !== 'admin' && (
                    <button
                      ...
                      className={`text-sm px-3 py-1 rounded-lg transition ${u.activo ? 'bg-red-100 text-red-600 hover:bg-red-200' : 'bg-green-100 text-green-600 hover:bg-green-200'}`}
                    >
